...
export default function Cta() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="max-w6xl mx-auto px-4 sm:px-6 font-sans">
        <div className="bg-gradient-to-r from-transparent via-gray-800/50 py-12 md:py-20">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="text-gray-300 pb-6" data-aos="fade-up" data-aos-delay={200}>
              Elevate your home and office aesthetics with our bespoke interior design solutions.
            </p>
