...
// import ContactImage from "@/public/images/aboutUs.jpg";
        ...
        <div className="bg-gradient-to-r from-transparent via-gray-800/50 py-12 md:py-20">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6" data-aos="fade-up" data-aos-delay={400}>
              ...
              <div className="rounded-lg overflow-hidden">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3153.835434508616!2d-122.41941568468106!3d37.77492927975954!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80858064cb45c8df%3A0xf8e98c849a3af50!2sSan+Francisco%2C+CA%2C+USA!5e0!3m2!1sen!2sin!4v1635936473723!5m2!1sen!2sin"
                  width="100%"
                  height="400"
                  style={{ border: 0 }}
